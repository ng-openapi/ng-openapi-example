...
import { BASE_PATH_PETSTOREURL, HTTP_INTERCEPTORS_PETSTOREURL } from "./tokens";
import { PetStoreUrlBaseInterceptor } from "./utils/base-interceptor";
import { DateInterceptor } from "./utils/date-transformer";

/** Configuration options for PetStoreUrl client */
export interface PetStoreUrlConfig {
    /** Base API URL */
    basePath: string;
...
/** import { providePetStoreUrlClient } from './api/providers'; */
/** */
...
/** }; */
/** ``` */
export function providePetStoreUrlClient(config: PetStoreUrlConfig): EnvironmentProviders {

    const providers: Provider[] = [
        // Base path token for this client
        {
            provide: BASE_PATH_PETSTOREURL,
            useValue: config.basePath
        },
        // Base interceptor that handles client-specific interceptors
        {
            provide: HTTP_INTERCEPTORS,
            useClass: PetStoreUrlBaseInterceptor,
            multi: true
        }
    ];
