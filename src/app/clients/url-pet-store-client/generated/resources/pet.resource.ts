...
* Generated Angular `httpResource` service for PetResource
...
export class PetResource {
    ...
    findPetsByStatus(status: Signal<'available' | 'pending' | 'sold'> | 'available' | 'pending' | 'sold', resourceOptions: HttpResourceOptions<Array<Pet>, unknown> & { defaultValue: NoInfer<Array<Pet>> }, requestOptions?: Omit<HttpResourceRequest, "method" | "url" | "params">): HttpResourceRef<Array<Pet>>;
    ...
    findPetsByTags(tags: Signal<Array<string>> | Array<string>, resourceOptions: HttpResourceOptions<Array<Pet>, unknown> & { defaultValue: NoInfer<Array<Pet>> }, requestOptions?: Omit<HttpResourceRequest, "method" | "url" | "params">): HttpResourceRef<Array<Pet>>;
