...
* Generated Base Interceptor for client PetStoreUrl
* Do not edit this file manually
*/
import { HttpEvent, HttpHandler, HttpInterceptor, HttpRequest, HttpContextToken } from "@angular/common/http";
import { inject, Injectable } from "@angular/core";
import { Observable } from "rxjs";
import { HTTP_INTERCEPTORS_PETSTOREURL, CLIENT_CONTEXT_TOKEN_PETSTOREURL } from "../tokens";

@Injectable()
export class PetStoreUrlBaseInterceptor implements HttpInterceptor {
    private readonly httpInterceptors: HttpInterceptor[] = inject(HTTP_INTERCEPTORS_PETSTOREURL);
